...
{
    const char* pszTimestamp = "I am learning coin development on this day of 2021";
    const CScript genesisOutputScript = CScript() << ParseHex("197784710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
      ...
      //  consensus.defaultAssumeValid = uint256S("0x1673fa904a93848eca83d5ca82c7af974511a7e640e22edc2976420744f2e56a"); //1155631
        ...
        genesis = CreateGenesisBlock(1621150193, 2001221058, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcf3497f41cb63be58dadbe6c62ba5040512a31c28278e2ceaa2aeeb35aaa6945"));
        assert(genesis.hashMerkleRoot == uint256S("0xc67dde9217f6c039776911bfcfdf42afccf676d34a22c590ecedf60fcea98800"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("192.168.162.137", "192.168.162.137", true));
       ...
       // vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xcf3497f41cb63be58dadbe6c62ba5040512a31c28278e2ceaa2aeeb35aaa6945"))
        ...
        chainTxData = ChainTxData{
            ...
            1621150193, // * UNIX timestamp of last known number of transactions
    ...
    CTestNetParams() {
      ...
      //  consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
       ...
       // consensus.defaultAssumeValid = uint256S("0x43a16a626ef2ffdbe928f2bc26dcd5475c6a1a04f9542dfc6a0a88e5fcf9bd4c"); //8711
        ...
        genesis = CreateGenesisBlock(1621150193, 691834, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x84513facacf2b09242f8ea849735f91d183c36475e1224dbba81482ec8c750b4"));
        assert(genesis.hashMerkleRoot == uint256S("0xc67dde9217f6c039776911bfcfdf42afccf676d34a22c590ecedf60fcea98800"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("192.168.162.137", "192.168.162.137"));
       ...
       // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x84513facacf2b09242f8ea849735f91d183c36475e1224dbba81482ec8c750b4")),
        };
...
public:
    CRegTestParams() {
      ...
      //  consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL;
        ...
        genesis = CreateGenesisBlock(1621150193, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x73e7d01caccec19ba01ff37e41a22367e7e1cd7af07e8a178f9272f3689e1a55"));
        assert(genesis.hashMerkleRoot == uint256S("0xc67dde9217f6c039776911bfcfdf42afccf676d34a22c590ecedf60fcea98800"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x73e7d01caccec19ba01ff37e41a22367e7e1cd7af07e8a178f9272f3689e1a55"))
        };
